...
**闯关叭叭**是一款趣味闯关练习微信小程序，提供语文、数学、英语的自测与进度记录，帮助巩固课内知识。

当前内容：古诗词默写练习、口算自测、英语单词认读（**1～2 年级**），进度仅保存在本地。

## 建议上架信息（教育信息展示）

完整步骤见：**[doc/上架流程.md](doc/上架流程.md)**

**推荐类目（个人主体）**：教育服务 → **教育信息展示**

> 说明：该类目适合无培训资质的个人主体；不保证必定过审。产品定位请保持「信息展示 + 趣味自测练习」，避免写成培训/网课/游戏。对外简介勿写「面向小学生」「不收费/免费」；电话审核若问用途，可口头说明供自家及朋友小孩练习。
...
```
趣味闯关练习工具。提供语文古诗词、数学口算、英语单词自测与进度记录，支持错题复习与每日自测。本地保存学习进度。
```

**审核说明（可粘贴）**：

```
本小程序为教育信息展示与趣味自测工具，非培训机构、不提供网课/直播课程，无内购与广告。
...
3. AppID 已配置为正式号 `wx0b996dbb62bf50cc`；开发者工具打开本仓库根目录即可
